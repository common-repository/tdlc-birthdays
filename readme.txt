...
Tags: buddypress, birthdays, widget, emails
Requires at least: 5.4 Buddypress 2.5
Tested up to: 6.6.1
Stable tag: 1.1.0
...
* New (nearly) most of the work to add the ability to send users birthday emails has been done, this should be complted by the next major release.
* New: plugin now checks if there is data to show, and does not print if that is the case.
* Upgrade:Improved styling in the widget output.
* Upgrade: Added security in the form of more sanitizing and escaping.
